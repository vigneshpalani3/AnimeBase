...
const AnimeItem = () => {
  ...
  const {dispatch,isLoading,randomAnime,getRandomAnime} = UseGlobalContext();
  ...
  async function getCharacters(){
    try{
      const responce = await fetch(`${baseUrl}/${randomAnime?.mal_id}/characters`);
    ...
    { isLoading ? <Loader /> :
      randomAnime? (
        <div className='anime-item'>
          <button className='reload-button' onClick={getRandomAnime}><TfiReload /></button>
